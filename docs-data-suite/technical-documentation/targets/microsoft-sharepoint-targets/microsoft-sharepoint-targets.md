...
## Configuring a SharePoint Target Service
...
4. Inside of the Add Target pop-up box, select the SharePoint Online option listed from the drop-down menu that appears under the Target Type field.

![](images/file-kLQIAR7zU9.png)

5. Inside the Add Target pop-up box, enter the fields to configure the SharePoint target:
    - **Target Type:** This field defines the kind of target to connect to.**Service Name:** Enter any name for the SharePoint target.
        
        ### **Configure Parameters:**
        
        - **Store path:** This path defines the exact specific folder in the filesystem. Format for SharePoint: **sitename/drivename/foldername**. For example: AparaviTest/Documents/targetFolder.
        ...
        - **Region:** This specifies the data center regions for the SharePoint account.
...
7. Once the system has completed validation with the SharePoint Online target service, the Submit button will be highlighted in orange to indicate that the button is now active. Click the Submit button in the bottom right corner of the Add Target pop-up box.

![](images/file-TPuQlSvnF8.png)
...
![](images/file-HrMiEWKfRU.png)

9. When clicked, the Save Changes pop-up box will appear. Click OK.
    ![](images/file-4EnfnAdW2u.png)
    

Once all changes have been successfully saved, the SharePoint target service will appear as an entry under the Targets sub-tab. Also, an alert message will display in the bottom left-hand corner to indicate that the target service has been successfully configured.
![](images/file-OUCUnfR0F0.png)
