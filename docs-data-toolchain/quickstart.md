...
- **[Guides](./examples/advanced-rag-pipeline/advanced-rag-pipeline.md)** — Walk through pre-built pipelines like Advanced RAG, Audio Transcription, and more.
- **[Nodes Overview](./nodes-overview.md)** — Browse all 68 nodes to see what's available.
- **[SDK](./sdk/python-sdk.md)** — Integrate pipelines into your TypeScript or Python applications.
- **[MCP Server](./mcp_server/rocketride-mcp-server/rocketride-mcp-server.md)** — Expose pipelines as tools for AI assistants like Claude and Cursor.
...
See the [VS Code Extension docs](./vscode-extension/usage.md) for more on managing deployments.
