...
- [`send()` / `sendFiles()`](../send-method/send-method.md) - Send data to a running pipeline
- [`terminate()`](../terminate-method/terminate-method.md) - Stop a running pipeline
- [`validate()`](../validate-method/validate-method.md) - Validate pipeline configuration before starting
