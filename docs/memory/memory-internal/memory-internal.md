...
The backing memory store for the [RocketRide Wave agent](../../agents/rocketride-wave/rocketride-wave.md). Only wireable to that agent — connect it via the `memory` invoke channel.
